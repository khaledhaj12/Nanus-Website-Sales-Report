...
// Orders table (maps to woo_orders database table)
export const orders = pgTable("woo_orders", {
  id: serial("id").primaryKey(),
  ...
  refundAmount: varchar("refund_amount", { length: 255 }),
  status: varchar("status", { length: 100 }).notNull(),
  orderDate: timestamp("order_date"),
  paymentMethod: varchar("payment_method", { length: 100 }),
  shippingTotal: varchar("shipping_total", { length: 255 }),
  taxTotal: varchar("tax_total", { length: 255 }),
  subtotal: varchar("subtotal", { length: 255 }),
  discountTotal: varchar("discount_total", { length: 255 }),
